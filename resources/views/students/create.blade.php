                        ...
                        <div class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="first_interv_date" id="date"
                                    max="{{ date('Y-m-d') }}" value="{{ old('first_interv_date') }}">
                    ...
                    <div class="col-md-4">
                        <div class="form-control">
                            ...
                            <div class="form-froup">
                                <label for="">実施日</label>
                                <input type="date" name="sec_interv_date" id="date"
                                    max="{{ date('Y-m-d') }}" value="{{ old('sec_interv_date') }}">
